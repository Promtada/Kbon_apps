  ...
  return (
    <div className="bg-white rounded-[2.5rem] border border-slate-100 p-8 shadow-sm min-h-[500px]">
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-800 tracking-tight">ประวัติการสั่งซื้อ</h1>
          <p className="text-sm font-medium text-slate-400 mt-1">ดูและติดตามสถานะคำสั่งซื้อทั้งหมดของคุณ</p>
        </div>
      </div>
