    ...
    <div className="bg-white rounded-[2.5rem] border border-slate-100 p-8 shadow-sm min-h-[500px]">
      <div className="flex items-center gap-4 mb-8">
        <div className="w-12 h-12 bg-emerald-50 rounded-2xl flex items-center justify-center">
          <Settings className="text-[#22C55E]" size={24} />
        </div>
        <div>
          <h1 className="text-2xl font-black text-slate-800 tracking-tight">ตั้งค่าบัญชี</h1>
          <p className="text-sm font-medium text-slate-400 mt-1">จัดการข้อมูลส่วนตัวและรหัสผ่าน</p>
        </div>
      </div>
